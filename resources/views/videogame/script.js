window.addEventListener('load', function(){
    // canvas setup
    Swal.fire({
        imageUrl: 'http://216.250.118.27/Freedomday/public/assets/img/home/img/logo.png',
        html:
          'Gracias por asistir al Freedom day 2022, disfruta del juego mientras esperas por el evento...',
      
        focusConfirm: false,
        confirmButtonText:
          '<i class="fa fa-thumbs-up"></i> A jugar!'
        ...
        class InputHandler {
            constructor(game){
                ...
                window.addEventListener('click', e=>{
                    if((e.target.id=='arribaButton') ||(e.target.id=='abajoButton') && this.game.keys.indexOf(e.key) === -1){
                        e.key='';
        ...
        class SoundController {
            constructor(){
                ...
                this.OhYeahBaby = document.getElementById('OhYeaBaby');
        ...
        class UI {
            ...
            draw(context){
                ...
                // score
                context.fillText('Tu record: ' + this.game.score, 20, 40);
                context.fillText('Record a vencer: '+this.game.winningScore ,400, 40);
                context.fillText('Tiempo limite: ' ,400, 100);

                // timer
                const formattedTime = (this.game.gameTime * 0.001).toFixed(1);
                context.fillText('Temporizador: ' + formattedTime, 20, 100);
                // game over messages
